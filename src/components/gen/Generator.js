  ...
  render() {
    return (
        <div className="flex flex-wrap place-content-center gap-1 bg-white h-full lg:mx-64 xl:mx-96">
          ...
          <GenInput text={this.state.quote.text} placeholderText="Enter text..." />
          <GenInputAuthor text={this.state.quote.author} placeholderText="Author" />
          <GenButtonSmall callbackImage={this.changeImage} buttonText="IMG" />
          <GenButtonLarge callbackText={this.generateText} buttonText="GENERATE" />
        </div>
    );
  }
}
